...
class PegawaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nip' => 'required_if:status_pegawai,PNS|unique:pegawai,nip',
            'nip_bps' => 'required_if:status_pegawai,PNS|unique:pegawai,nip_bps',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'id_akun'        => 'required',
            'status_pegawai' => 'required|in:PNS,Non PNS',
            'nip' => 'required_if:status_pegawai,PNS|unique:pegawai,nip,' . $pegawai->id_pegawai . ',id_pegawai',
            'nip_bps' => 'required_if:status_pegawai,PNS|unique:pegawai,nip_bps,' . $pegawai->id_pegawai . ',id_pegawai',
            'nama_pegawai'   => 'required',
            'jabatan'        => 'required',
            'subbagian'      => 'nullable|string|max:100',
            'golongan_akhir' => 'required',
